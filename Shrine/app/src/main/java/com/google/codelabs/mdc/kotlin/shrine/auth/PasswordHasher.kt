 ...
 *
 * Uses salted PBKDF2 (HMAC-SHA1, chosen for compatibility down to the app's minSdk 16).
 * Salts and hashes are stored Base64-encoded. This hardens local credential storage; it is
...
object PasswordHasher {
    ...
    /** Hash [password] with the given Base64 [saltBase64]; returns the Base64-encoded hash. */
