...
import com.google.codelabs.mdc.kotlin.shrine.core.model.OrderWithLines
...
/**
 * Static sample data for `@Preview` rendering only. Mirrors the shape of [com.google.codelabs.mdc.kotlin.shrine.core.database.CatalogSeed]
