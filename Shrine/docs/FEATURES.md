...
**End to end:**
- UI: `RegisterScreen`/`RegisterContent` in [`AuthScreens.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/AuthScreens.kt) — includes a password strength meter and visibility toggle.
...
**End to end:**
- UI: `HomeScreen`/`HomeContent` in [`HomeScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/HomeScreen.kt).
...
**End to end:**
- UI: `CategoryScreen`/`CategoryContent` in [`CategoryScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/CategoryScreen.kt).
...
**End to end:**
- UI: `SearchScreen`/`SearchContent` + `FilterSheet` in [`SearchScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/SearchScreen.kt).
...
**End to end:**
- UI: `ProductDetailScreen`/`ProductDetailContent` in [`ProductDetailScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/ProductDetailScreen.kt) — image pager with dots, rating + review count, color/variant chips, quantity stepper, sticky add-to-cart bar, and a "you may also like" row.
...
**End to end:**
- UI: `CartScreen`/`CartContent` in [`CartScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/CartScreen.kt) — per-line variant subtitle, stepper, remove; summary (Subtotal / Shipping (Free) / Total) and a sticky "Checkout" bar. Empty state when no items.
...
**End to end:**
- UI: `CheckoutScreen`/`CheckoutContent` in [`CheckoutScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/CheckoutScreen.kt) — address/delivery/payment/summary cards; total = subtotal + delivery shipping.
...
**End to end:**
- UI in [`OrderScreens.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/OrderScreens.kt): **OrderPlaced** (animated check, order number, estimated arrival; Track order is a placeholder), **OrderHistory** (status tabs All/Active/Delivered with status `AssistChip`s and thumbnails), **OrderDetail**.
...
**End to end:**
- UI: `WishlistScreen`/`WishlistContent` in [`WishlistScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/WishlistScreen.kt) — filled-heart toggle removes; QuickAddButton adds to cart; empty state.
...
**End to end:**
- UI: `ProfileScreen`/`ProfileContent` in [`ProfileScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/ProfileScreen.kt) — avatar, Orders/Saved/Reviews stats, rows to My orders / Addresses / Payment methods / Edit profile / Settings / Help center. **Guests** see Sign in + Create account; signed-in users see Sign out.
- `ProfileViewModel` reads `SessionRepository` + order/saved counts. **Edit profile** ([`EditProfileScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/EditProfileScreen.kt)) edits name/email/phone/DOB (DatePicker) via `AuthRepository`/`SessionRepository`.
...
**End to end:**
- UI: `SettingsScreen`/`SettingsContent` in [`SettingsScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/SettingsScreen.kt) — theme `SegmentedButton` (System/Light/Dark), Large-imagery switch, Order-updates/Promotions switches, About/version.
...
**End to end:**
- UI: [`AddressesScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/AddressesScreen.kt) and [`PaymentMethodsScreen.kt`](../app/src/main/java/com/skystone1000/shrine/ui/screens/PaymentMethodsScreen.kt) — list + FloatingActionButton + ModalBottomSheet add/edit forms, per-user.
